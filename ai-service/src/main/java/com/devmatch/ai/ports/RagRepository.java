...
//  Top-K by chunk vector of the specific owner
  List<RagChunk> topKByVector(String ownerType, String ownerId, float[] queryVec, int k, Map<String, String> filters);

//  Top-M by the whole text
  List<RagChunk> topMByFts(String ownerType, String ownerId, String query, int m, Map<String, String> filters);
}
